...
Auth::routes();
Route::get('/auth/login/facebook', 'Auth\LoginController@redirectToProvider');
Route::get('/auth/login/facebook/callback', 'Auth\LoginController@handleProviderCallback');
